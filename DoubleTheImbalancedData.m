...
grid on;
title('Numbers of images in different classes in the original unbalanced dataset')  
xlabel('Different classes');
ylabel('Number of images');
ylim([0 3000])

%% augment 43 traffic sign classes double
for d = 1:numimds43/30
